...
Sumo_config = [
    'sumo-gui',
    '-c', 'Synthetic Network\Data\Dummy.sumocfg',
    '--step-length', '0.10',
    '--delay', '50',
...
def build_model(state_size, action_size):
    ...
    model.add(keras.layers.Input(shape=(state_size,)))               # Input layer
    model.add(keras.layers.Dense(24, activation='relu'))             # First hidden layer
    model.add(keras.layers.Dense(24, activation='relu'))             # Second hidden layer
    model.add(keras.layers.Dense(action_size, activation='linear'))  # Output layer
    model.compile(
        loss='mse',
...
def get_state():  #3&4. Constraint 3 & 4
    ...
    detector_Node1_2_EB_0 = "Traffic Panel Detector 1"
    detector_Node1_2_EB_1 = "Traffic Panel Detector 2"
    detector_Node1_2_EB_2 = "Traffic Panel Detector 3"
    
    # Detector IDs for Node2-7-SB
    detector_Node2_7_SB_0 = "Traffic Panel Detector 4"
    detector_Node2_7_SB_1 = "Traffic Panel Detector 5"
    detector_Node2_7_SB_2 = "Traffic Panel Detector 6"
    
    # Traffic light ID
    traffic_light_id = "Central"
...
def apply_action(action, tls_id="Central"): #5. Constraint 5
    """
...
plt.savefig("Synthetic Network\Results\Deep Q Traffic Light\Metrics.png", dpi=300, bbox_inches='tight')
