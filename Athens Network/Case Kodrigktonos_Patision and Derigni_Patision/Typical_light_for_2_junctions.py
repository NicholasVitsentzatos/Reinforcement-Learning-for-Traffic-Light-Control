...
print("\n=== Starting Simulation with Metrics for Two Junctions ===")
for step in range(TOTAL_STEPS):
    ...
    # Get metrics for both junctions
    ...
    if step % 100 == 0:
        ...
        f"\n  Queue Lengths -> Kodrigktonos: {total_queue_kodrigktonos}, Derigni: {total_queue_derigni}, Total: {total_queue}"
...
save_path = r"Athens Network\Case Kodrigktonos_Patision and Derigni_Patision\Results\Typical Traffic Lights\Combined_Metrics.png"
